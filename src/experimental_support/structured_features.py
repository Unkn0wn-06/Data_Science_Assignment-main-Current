"""Target-free structured interactions required by the final experiment."""
...
def add_non_target_features(
    ...
    """Add the exact deterministic features used by the frozen models."""
    result = frame.copy()
...
def engineered_feature_lists(
    ...
    *,
    ...
    """Return the frozen non-micro feature schema used by the final models."""
    if include_micro:
        raise ValueError("Micro-market target aggregates are not part of the final workflow.")
